...
//                backgroundColor = CoolerUIPanel.BackgroundDefaultUnselectedColor,
...
//            {
//                Load(ConfigCIVEInstance, FilePath);
//            };
...
//            }
//            NameText.TextColor = Color.Lerp(NameText.TextColor, IsMouseHovering ? Color.White : Color.LightGray, .05f);
...
//            if (currentStyle != 0)
//                DrawCoolerPanel_Bound(spriteBatch, currentStyleTex, innerPosition + innerSize * .5f, innerSize.Y, innerSize.X / 24f, MathHelper.PiOver2, (Color.Cyan * .5f) with { A = 0 }, 1f, 1, 0);
//            else
//            {
//                var rectangle = Utils.CenteredRectangle(innerPosition + innerSize * .5f, innerSize);
//                DrawCoolerPanel(spriteBatch, ref rectangle, Color.White, texStyle: 0);
